...
?></td>
        ...
        <td class="<?php if($row_nr %2 == 0) {echo 'first_row_detailed_screen';}else{echo'second_row_detailed_screen';} $row_nr++;?>"><?php echo $str["ACP_CRON_COMMENT"]."update.php ".get_cron_key();?></td>
      </tr>
      <tr>
