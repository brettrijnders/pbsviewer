...
$str["ACP_PB_SS_DIR_COMMENT"]			=	"Default = svss. This is the name of your PB screenshot directory";
$str["ACP_PB_LOG_DIR"]					=	"PB log directory name";
$str["ACP_PB_LOG_DIR_COMMENT"]			=	"Default = svlogs. This is the name of your PB log directory";
...
$str["ACP_PBSVSS_IU_NR_SCREENS_COMMENT"]=	"Number of screens to download with Incremental Update (IU) during each update cycle, default = 20";
$str["ACP_PBSVSS_IU_NR_LOGS"]			=	"Number of logs (IU)";
$str["ACP_PBSVSS_IU_NR_LOGS_COMMENT"]	=	"Number of log files to download with Incremental Update (IU) during each update cycle, default = 2";
$str["ACP_PBSVSS_IU_UPDATE_TIME"]		=	"Update time (IU)";
$str["ACP_PBSVSS_IU_UPDATE_TIME_COMMENT"]=	"Maximum time for each update cycle with Incremental update, default = 30 seconds";
$str["ACP_PBSVSS_IU_WAIT_TIME"]			=	"Wait time (IU)";
$str["ACP_PBSVSS_IU_WAIT_TIME_COMMENT"]	=	"Time to wait before continuing with next update cycle, default = 3 seconds";
