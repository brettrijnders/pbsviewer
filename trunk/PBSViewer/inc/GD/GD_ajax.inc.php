...
if($im && negate($im))
{
    ...
    $IMGsrc = 'download/temp.png';
    list($widthIMG, $heightIMG, $typeIMG, $attrIMG) = getimagesize($IMGsrc);
    echo "
    <img src=\"".$IMGsrc."\" style=\"width:".$widthIMG."px; height: ".$heightIMG."px;\" onmouseover=\"TJPzoomif(this);\" id=\"unique1337\" alt=\"".$fid.'png'."\">";
}
else
{
	...
	{
		$IMGsrc = 'download/'.$_GET['imgfid'].'.png';
    	list($widthIMG, $heightIMG, $typeIMG, $attrIMG) = getimagesize($IMGsrc);
